...
const Navbar = () => {
    ...
    return (
        <div className="bg-black flex justify-between w-full items-center xl:py-4">
            <div className={`absolute text-white w-[100%] top-0 left-[50%] translate-x-[-50%] ${toggleMenu ? "block" : "hidden"}`}>
                <div className="px-8 bg-black items-center">
                    <div className='py-8 w-full flex justify-end cursor-pointer'>
                        <img src="./image/X.svg" alt="Altclose" onClick={() => setToggleMenu(!toggleMenu)} />
                    </div>
                    <ul className="flex flex-col list-none items-center gap-[50px]">
                        <li className="flex items-center font-bold text-[21px] xl:text-[18px] pb-[30px] leading-normal">
                            <img className="w-full" src="./Logo.svg" alt="AltLogo" />
                        </li>
                    ...
                    <ul className='flex justify-center list-none items-center gap-[20px] mt-[180px] pb-[100px]'>
                        <li>
                            <img className='w-[70px] h-[70px]' src="./Twitter_Logo 1.svg" alt="AltTwitter" />
                        </li>
                        <li>
                            <img className='w-[70px] h-[70px]' src="./Instagram_Logo 1.svg" alt="AltInstagram" />
                        </li>
                        <li>
                            <img className='w-[70px] h-[70px]' src="./Discord-Logo 1.svg" alt="AltDiscord" />
                        </li>
                        <li>
                            <img className='w-[70px] h-[70px]' src="./youtube_icon 2.svg" alt="AltYoutube" />
                        </li>
                    </ul>
                </div>
            </div>
            <img className="xl:w-[200px] xl:h-[200px] md:w-[150px] md:h-[150px] max-md:w-[80px] max-md:h-[80px]" src="./Logo.svg" alt="AltLogo" />
