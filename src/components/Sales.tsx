            ...
            <div className="mt-[130px] flex w-full justify-between pb-[137px] max-lg:pb-[108px] max-sm:pb-[78px] max-lg:mt-[100px] max-sm:mt-[60px] max-xl:flex-col">
                <div className="pl-[160px] text-white max-xl:mb-20 max-xl:pl-[66px]">
                    ...
                    <ul className="mt-[27px]">
                        <li className="font-normal text-[24px] max-lg:text-[20px] max-sm:text-[14px] leading-normal list-disc">Non-Custodial Staking on MDToken.io</li>
                        <li className="font-normal text-[24px] max-lg:text-[20px] max-sm:text-[14px] leading-normal list-disc">Non-Custodial Staking on Cardano Lands</li>
                        <li className="font-normal text-[24px] max-lg:text-[20px] max-sm:text-[14px] leading-normal list-disc">Non-Custodial Staking on Ape Society</li>
                        <li className="font-normal text-[24px] max-lg:text-[20px] max-sm:text-[14px] leading-normal list-disc">50% of Monthly Royalties to all Top 1K holders</li>
                        <li className="font-normal text-[24px] max-lg:text-[20px] max-sm:text-[14px] leading-normal list-disc">PFP Utilization</li>
                        <li className="font-normal text-[24px] max-lg:text-[20px] max-sm:text-[14px] leading-normal list-disc">Benifets towards all Future Whitelists</li>
                        <li className="font-normal text-[24px] max-lg:text-[20px] max-sm:text-[14px] leading-normal list-disc">Access to MD Racing Game</li>
                    </ul>

                </div>
                <div className="flex-col w-[54%] max-xl:ml-auto max-xl:w-full max-xl:pl-[41px]">
                    <p className="bg-[#85FF10] items-center font-semibold text-[32px] max-lg:text-[28px] max-sm:text-[24px] ml-auto leading-normal w-full pt-[20px] pb-[17px] pl-[49px] max-lg:pt-[18px] max-lg:pb-[15px] max-lg:pl-[28px] max-sm:pt-[16px] max-sm:pb-[14px] max-sm:pl-[19px]">Highest Sale: 76,069 ADA</p>
                    <p className="bg-[#85FF10] items-center font-semibold text-[32px] max-lg:text-[28px] max-sm:text-[24px] ml-auto mt-[49px] leading-normal w-[90%] pt-[20px] pb-[17px] pl-[49px] max-lg:pt-[18px] max-lg:pb-[15px] max-lg:pl-[28px] max-sm:pt-[16px] max-sm:pb-[14px] max-sm:pl-[19px]">Total Royalties Distributed: 76,069 ADA</p>
                    <p className="bg-[#85FF10] items-center font-semibold text-[32px] max-lg:text-[28px] max-sm:text-[24px] ml-auto mt-[60px] leading-normal w-[75%] pt-[20px] pb-[17px] pl-[49px] max-lg:pt-[18px] max-lg:pb-[15px] max-lg:pl-[28px] max-sm:pt-[16px] max-sm:pb-[14px] max-sm:pl-[19px]">Total Staking Platforms: 3 </p>
                </div>
            </div>
            <div>
