          ...
          <div className="flex w-full items-center justify-between px-4">
            <div>
              <button
                ...
                } absolute right-4 top-1/2 block -translate-y-1/2 rounded-lg border-2 px-3 py-[6px] ring-primary focus:ring-2 lg:hidden`}
              >
...
const ListItem = (props: { children: any, NavLink: string }) => {
